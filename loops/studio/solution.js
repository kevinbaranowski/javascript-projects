...
function askForNumber() {
  ...
  while (numMeals < 1 || numMeals > 6 || isNaN(numMeals)) {
    ...
    if (numMeals >= 1 && numMeals <= 6) {
      console.log('Validation successful. Valid number of meals entered.')
    } else if (isNaN(numMeals)) {
      console.log('Validation failed. Please enter a number and try again.')
    } else {
      console.log('Validation failed. Please enter a number from 1 to 6.')
    }
  }
